...
final class SearchServiceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        searchService = DefaultMovieService(httpClient: mockHttpClient)
    }
    ...
    func testGetGenresFetchesFromNetwork() async throws {
        ...
        // When
        let response = try await searchService.searchMovies(by: "test")
    ...
    func testGetGenresThrowsErrorWhenHTTPClientThrowsError() async throws {
        ...
        // When & Then
        do {
            _ = try await searchService.searchMovies(by: "test")
